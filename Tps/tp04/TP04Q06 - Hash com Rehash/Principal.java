...
class Tabela {
    ...
    public int reHash(String title) {
        // Função que calcula a rehash de um title
        int soma = 0;
        for (int i = 0; i < title.length(); i++) {
            soma += (int) title.charAt(i);
        }
    ...
    public void inserir(Show show) {
        ...
        if (tabela[hash] == null) {
            tabela[hash] = show;
            // Apos verificar que o hash não é nulo, e não éo proprio show, chama o rehash
    ...
    public boolean pesquisar(String title) {
        ...
        if (tabela[hash] == null) {
            ...
            // verifica o rehash se o hash falhar
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        try {
            FileWriter arq = new FileWriter("869899_hashRehash.txt");
