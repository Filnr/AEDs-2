...
class Lista{
    ...
    public void inserir(Show valor){
...
class Tabela {
    ...
    public boolean pesquisar(String title) {
        ...
        // Verica se a  tabela é null, para economizar comparações
        // desnecessarias
        Lista lista = tabela[hash];
        if(!lista.isEmpty()){
            No i = lista.getP();
            while(i != null && !encontrado){
                if(i.getShow().getTitle().equals(title)){
                    encontrado = true;
                }
                i = i.prox;
            }
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        try {
            FileWriter arq = new FileWriter("869899_hashIndireta.txt");
